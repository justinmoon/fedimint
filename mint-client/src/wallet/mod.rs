...
use minimint_shared::FeeConsensus;
use minimint_wallet::config::WalletClientConfig;
use minimint_wallet::tweakable::Tweakable;
use minimint_wallet::txoproof::{PegInProof, PegInProofError, TxOutProof};
...
mod tests {
    ...
    use minimint_wallet::bitcoind::test::{FakeBitcoindRpc, FakeBitcoindRpcController};
    use minimint_wallet::config::WalletClientConfig;
    use minimint_wallet::db::UTXOKey;
    use minimint_wallet::{SpendableUTXO, Wallet};
    use std::str::FromStr;
    use std::sync::Arc;

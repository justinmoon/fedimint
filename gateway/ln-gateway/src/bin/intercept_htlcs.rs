// This example connects to LND and uses router rpc to intercept htlcs, inspect
// the details, then resume forwarding them
//
// The program accepts four arguments: address, cert file, macaroon file
// Example run: `cargo run --features=routerrpc --example intercept_htlcs
// <address> <tls.cert> <file.macaroon>`
